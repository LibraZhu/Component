...
public class FragmentContainerHelper {
     ...
     */
    public static PositionData getImitativePositionData(List<PositionData> positionDataList,
            int index) {
    ...
    public void handlePageSelected(int selectedIndex, boolean smooth) {
        ...
        if (smooth) {
            ...
            mScrollAnimator.setFloatValues(currentPositionOffsetSum,
                                           selectedIndex);    // position = selectedIndex, positionOffset = 0.0f
    ...
    private void dispatchPageScrolled(int position, float positionOffset,
