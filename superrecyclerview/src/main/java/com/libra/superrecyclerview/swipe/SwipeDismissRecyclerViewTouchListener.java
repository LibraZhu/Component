...
public class SwipeDismissRecyclerViewTouchListener implements View.OnTouchListener {
     ...
     * through
     * to this listener. This will ensure that this {@link SwipeDismissRecyclerViewTouchListener}
     * is
    ...
    @SuppressLint("AndroidLintClickableViewAccessibility") @Override
    ...
    private void caseMotionActionMove(MotionEvent motionEvent) {
        ...
        if (Math.abs(deltaX) > mSlop && Math.abs(deltaY) < Math.abs(deltaX) / 2) {
            ...
            cancelEvent.setAction(
                    MotionEvent.ACTION_CANCEL | (MotionEventCompat.getActionIndex(motionEvent)
    ...
    private void caseMotionActionUp(MotionEvent motionEvent) {
        ...
        if (dismiss && mDownPosition != INVALID_POSITION) {
            ...
            animate(mDownView).translationX(dismissRight ? mViewWidth : -mViewWidth)
                    .alpha(0)
    ...
    class PendingDismissData implements Comparable<PendingDismissData> {
        ...
        @Override public int compareTo(@NonNull PendingDismissData other) {
