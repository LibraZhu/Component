...
public class SuperRecyclerView extends FrameLayout {
    ...
    protected void initAttrs(AttributeSet attrs) {
        ...
        try {
            ...
            mPaddingTop =
                    (int) a.getDimension(R.styleable.superrecyclerview_recyclerPaddingTop, 0.0f);
            mPaddingBottom =
                    (int) a.getDimension(R.styleable.superrecyclerview_recyclerPaddingBottom, 0.0f);
            mPaddingLeft =
                    (int) a.getDimension(R.styleable.superrecyclerview_recyclerPaddingLeft, 0.0f);
            mPaddingRight =
    ...
    private void initView() {
        ...
        if (mEmptyId != 0) mEmptyView = mEmpty.inflate();
    ...
    private void setAdapterInternal(RecyclerView.Adapter adapter, boolean compatibleWithPrevious,
        ...
        if (mEmptyId != 0) {
            if (mRecycler.getAdapter() instanceof WrapperAdapter) {
                if (mRecycler.getAdapter().getItemCount() <= 2 && mEmptyId != 0) {
    ...
    public static class RecyclerItemClickListener implements RecyclerView.OnItemTouchListener {
        ...
        public boolean onInterceptTouchEvent(RecyclerView view, MotionEvent e) {
            ...
            if (childView != null && mListener != null && mGestureDetector.onTouchEvent(e)) {
                if (view.getAdapter() instanceof WrapperAdapter) {
